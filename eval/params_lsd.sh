...
mkdir eval/params_lsd

echo "Running search space on faster_lsd"

python -m gluefactory.eval.hpatches_lines_grid_search --conf gluefactory/configs/eval/fastlsd+LM.yaml --overwrite > "eval/params_lsd/output.txt"